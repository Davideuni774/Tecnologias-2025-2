...
<head>
  ...
  <title>Draconis - Crear Cuenta</title>
  ...
  <section class="categorias">
    <div class="create-account-container">
      <div class="text-section">
        <h1>Crea tu cuenta<br>en Draconis</h1>
      </div>
      ...
      <div class="form-section">
        ...
        <form method="POST" action="">
          ...
          <div class="input-group">
            <span>🔒</span>
            <input type="password" name="confirmar_clave" placeholder="Confirma tu contraseña" required>
          </div>

          <button type="submit" class="button primary">Crear cuenta</button>
        </form>
        <a href="iniciosesion.php"><button type="button" class="button secondary">Ya tengo cuenta</button></a>
      </div>
    </div>
  </section>
