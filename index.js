  ...
  const headerHTML = () => `
    ...
    <header>
      ...
      <div class="search-container">
        <img src="https://imgur.com/1CvowTj.png" alt="Buscar" style="height:18px;margin-right:8px">
        <input type="search" placeholder="Buscar">
      </div>
      <div class="header-right">
        <img src="https://imgur.com/orxdqLp.png" alt="Carrito">
      </div>
    </header>
    <nav>
      <a href="#">Lo último</a>
  ...
  const footerHTML = () => `
    <footer>
      <div class="footer-grid">
        ...
        <div>
          <img src="https://imgur.com/RqgEn01.png" alt="mujer verde">
        </div>
      </div>
    </footer>
    <div class="metodos">
      ...
      <div class="payment-logos">
        <img src="https://imgur.com/H4nivaw.png" alt="Nequi">
        <img src="https://imgur.com/ibVUeR5.png" alt="Paypal">
        <img src="https://imgur.com/8sHIBqR.png" alt="Daviplata">
        <img src="https://imgur.com/QxLErK6.png" alt="Mercado Pago">
      </div>
    </div>
